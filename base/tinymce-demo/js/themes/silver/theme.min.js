...
! function() {
              ...
              t.push(a), o[a] = (...o) => {
                  ...
                  return {
                      ...
                      match: e => {
                          ...
                          if (!Y(t, (e => R(n, e)))) throw new Error("Not all branches were specified when using match. Specified: " + n.join(", ") + "\nRequired: " + t.join(", "));
  ...
  const la = e => {
      ...
      Za = (e, t) => {
          ...
          return L(a, (e => Et(t, e))), Ct(t, r), Wa(t, m), ja(t, u), L(c, (e => Ht(t, e))), Bt(t, l), e.innerHtml.fold((() => {
          ...
          const s = e.bubble,
              ...
              h = p ? c : ((e, t) => {
                  const {
                      ...
                      width: l,
                      height: c
                  } = e, d = Math.max(o, s - l), u = Math.max(n, r - c), m = Yi(a, o, d), g = Yi(i, n, u), p = Math.min(m + l, s) - m, h = Math.min(g + c, r) - g;
                  return Ko(m, g, p, h)
              })(c, a),
  ...
  var wd = Object.freeze({
      ...
      reset: (e, t, o, n) => {
          const s = n.element;
          L(["position", "left", "right", "top", "bottom"], (e => Ht(s, e))), (e => {
              Et(e, ql)
          })(s), o.clear(n.uid)
      }
  });
  const Sd = Ol({
      ...
      Ud = (e, t, o) => {
          ...
          Dt(e.element, "position", Sd.getMode(n)), ((e, t, o, n) => {
              Nt(e.element, t).fold((() => {
                  Et(e.element, o)
              }), (t => {
                  kt(e.element, o, t)
      ...
      fg = e => {
          const t = [us("onEscape"), us("onEnter"), ys("selector", '[data-alloy-tabstop="true"]:not(:disabled)'), ys("firstTabstop", 0), ys("useTabstopAt", E), us("visibilitySelector")].concat([e]),
              ...
              r = (e, t, s, r) => {
                  ...
                  return n(e, s).bind((t => $(a, k(Ze, t)).bind((t => ((e, t, n, s, r) => r(t, n, (e => ((e, t) => o(e, t) && e.useTabstopAt(t))(s, e))).fold((() => s.cyclic ? A.some(!0) : A.none()), (t => (s.focusManager.set(e, t), A.some(!0)))))(e, a, t, s, r)))))
              },
              a = (e, t, o) => {
      ...
      Lh = fm({
          ...
          factory: (e, t) => {
              const o = Ql(),
                  ...
                  a = Gm.highlight,
                  i = (t, o) => {
                      a(t, o), Gm.getHighlighted(o).orThunk((() => Gm.getFirst(o))).each((n => {
                  ...
                  u = (t, o, n) => A.from(n[0]).bind((s => o.lookupMenu(s).bind((s => {
                      if ("notbuilt" === s.type) return A.none(); {
                          ...
                          })), yt(r.element) || Kp.append(t, ai(r)), ja(r.element, [e.markers.backgroundMenu]), i(t, r), c(t, o, n), A.some(r)
                      }
                  }))));
              let m;
              ! function(e) {
      ...
      Ph = fm({
          ...
          factory: (e, t) => {
              const o = (t, o, n, s) => {
                      ...
                      Xd.openWhileCloaked(t, o, (() => Sd.positionWithinBounds(r, t, n, s()))), pu.setValue(t, A.some({
                          mode: "position",
                          config: n,
                          getBounds: s
                      }))
                      ...
                      const r = ((e, t, o, n, s) => {
                          ...
                          return Lh.sketch({
                              ...
                              onRepositionMenu: (e, t, n) => {
                                  const a = r().getOrDie();
                                  Sd.positionWithinBounds(a, t, o, s()), L(n, (e => {
  ...
  var nf, sf, rf = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
  ...
  const hb = "tox-menu-nav__js",
      ...
      Yb = (e, t, o) => Dh.parts.items({
          preprocess: n => {
              const s = H(n, o);
              return "auto" !== e && e > 1 ? qb({
                  tag: "div",
                  classes: ["tox-collection__group"]
              }, e)(s) : Xb(s, ((e, o) => "separator" === t[o].type))
          }
      }),
      Kb = (e, t, o = !0) => ({
          dom: {
      ...
      ev = (e, t, o, n, s) => {
          ...
          if ("normal" === s.menuType || "searchable" === s.menuType) {
              const t = "searchable" !== s.menuType ? Kb(n, o) : "search-with-field" === s.searchMode.searchMode ? ((e, t, o) => {
      ...
      _v = Os("onAction", b),
      Tv = e => Ss("type", e),
      Ev = e => Qn("name", "name", vn((() => la(`${e}-name`))), Hn),
      Av = Dn([tv, pv]),
      ...
      Jv = [Sv, pv, vv, ("menuitem", Qn("value", "value", vn((() => la("menuitem-value"))), Nn())), Ov];
  ...
  var gy = Object.freeze({
                      ...
                      t.resetTimer((() => {
                          (o => {
                              if (!t.isShowing()) {
                                  ...
                                  t.setTooltip(s), Ad(n, s), e.onShow(o, s), Sd.position(n, s, {
                                      anchor: e.anchor(o)
                                  })
                              }
                          })(o)
      ...
      hy = [os("lazySink"), os("tooltipDom"), ys("exclusive", !0), ys("tooltipComponents", []), ys("delay", 300), ks("mode", "normal", ["normal", "follow-highlight"]), ys("anchor", (e => ({
          type: "hotspot",
          hotspot: e,
          layouts: {
  ...
  const xy = (e, t) => {
      ...
      wy = (e, t) => {
          ...
          })), e.on("SwitchMode", (() => xy(t, e.mode.isReadOnly()))), mf(e) && e.mode.set("readonly")
      },
      Sy = () => Al.config({
          channels: {
              [vy]: {
      ...
      By = (e, t, o, n) => {
          ...
          return {
              ...
              itemBehaviours: kl([Jp("item-events", [Ay(e, o), Ty(e, s), Ey(e, s)]), (r = () => !e.enabled || n.isDisabled(), Rm.config({
                  disabled: r,
      ...
      Uy = (e, t, o, n = A.none()) => "color" === e.presets ? ((e, t, o) => {
          const n = e.ariaLabel,
              s = e.value,
          ...
          const s = {
              ...
              r = o ? e.iconContent.map((e => ef(e, s, t.icons, n))).orThunk((() => A.some({
                  dom: s
              }))) : A.none(),
              a = e.checkMark,
              i = A.from(e.meta).fold((() => Ny), (e => ve(e, "style") ? k(zy, e.style) : Ny)),
              l = e.htmlContent.fold((() => e.textContent.map(i)), (e => A.some(Vy(e, [wb]))));
          return {
              dom: Py(e.ariaLabel),
              optComponents: [r, l, e.shortcutContent.map(Hy), a, e.caret]
          }
      })(e, t, o, n),
      Wy = (e, t) => be(e, "tooltipWorker").map((e => [by.config({
          lazySink: t.getSink,
          tooltipDom: {
              tag: "div",
  ...
  const kx = {},
      ...
      Ax = e => {
          return (t = e, Ky(t) ? A.some({
              value: Jy(t)
          }) : A.none()).orThunk((() => dx(e).map(Qy))).getOrThunk((() => {
      ...
      Ix = "#000000",
      Rx = (e, t) => t === Mx && e.options.isSet("color_map_foreground") ? Fx("color_map_foreground")(e) : t === Dx && e.options.isSet("color_map_background") ? Fx("color_map_background")(e) : Fx("color_map")(e),
      ...
      zx = (e, t = "default") => Math.round(t === Mx ? Fx("color_cols_foreground")(e) : t === Dx ? Fx("color_cols_background")(e) : Fx("color_cols")(e)),
      Hx = Fx("custom_colors"),
          ...
          const o = Ve(e.selection.getStart()),
              n = "hilitecolor" === t ? Is(o, (e => {
                  if (Ge(e)) {
                      ...
                      return Ce(dx(t).exists((e => 0 !== e.alpha)), t)
                  }
                  return A.none()
      ...
      Gx = (e, t, o) => e.concat((e => H(Cx(e).state(), (e => ({
          type: "choiceitem",
          text: e,
          icon: "checkmark",
          value: e
      ...
      Yx = (e, t, o, n, s) => {
          e.ui.registry.addSplitButton(t, {
              ...
              onSetup: o => {
                  ...
                  return e.on("TextColorChange", n), fx(bx(e)(o), (() => {
      ...
      Qx = (e, t, o, n, s, r, a) => we(H(e, (i => {
          return "choiceitem" === i.type ? (l = i, qn("choicemenuitem", Qv, l)).fold(Zb, (i => A.some(((e, t, o, n, s, r, a, i = !0) => {
              const l = Uy({
                  presets: o,
          ...
          })(i, 1 === o, n, t, r(i.value), s, a, Jb(e))))) : A.none();
          var l
      }))),
      ew = (e, t) => {
          const o = Ab(t);
      ...
      aw = {
          ...
          colorswatch: (e, t) => {
              const o = ((e, t) => {
                      ...
                      return e.initData.colors.fold((() => Gx(t.colorinput.getColors(e.initData.storageKey), e.initData.storageKey, o)), (e => e.concat(Wx(o))))
                  })(e, t),
                  n = t.colorinput.getColorCols(e.initData.storageKey),
                  s = "color",
                  r = {
                      ...Zx(la("menu-value"), o, (t => {
                          e.onAction({
                              value: t
                          })
  ...
  const uw = Ol({
      ...
      Cw = (e, t) => e.getSystem().getByUid(t.uid + "-" + vw()).map((e => () => sn.value(e))).getOrThunk((() => t.lazySink.fold((() => () => sn.error(new Error("No internal sink is specified, nor could an external sink be found"))), (t => () => t(e))))),
      Ow = e => {
          ...
          factory: (e, t, o, n) => {
              const s = e => {
                  ...
                  a = {
                      ...
                      refetch: t => uw.getExistingCoupled(t, "sandbox").fold((() => r(t, b, zh.HighlightMenuAndItem).map(b)), (o => ww(e, w, t, o, n, b, zh.HighlightMenuAndItem).map(b))),
                      isOpen: dh.isOn,
                      close: e => {
                          dh.isOn(e) && r(e, b, zh.HighlightMenuAndItem).get(b)
                      },
      ...
      Bw = (e, t, o) => {
          Ub(e).each((e => {
              ...
              })(e, o), (Ua((n = t).element, Gb) ? A.some(n.element) : pi(n.element, "." + Gb)).each((t => {
      ...
      Iw = e => uw.getExistingCoupled(e, "sandbox").bind(Pb).map(Wb).map((e => e.fetchPattern)).getOr("");
  var Rw;
  ! function(e) {
  ...
  const Nw = (e, t, o, n, s) => {
          ...
          switch (e.type) {
              case "menuitem":
                  return (i = e, qn("menuitem", sy, i)).fold(Zb, (e => A.some(((e, t, o, n = !0) => {
                      const s = Uy({
                          presets: "normal",
                          iconContent: e.icon,
                          textContent: e.text,
              ...
              case "nestedmenuitem":
                  return (e => qn("nestedmenuitem", ry, e))(e).fold(Zb, (e => A.some(((e, t, o, n = !0, s = !1) => {
              ...
              case "togglemenuitem":
                  return (e => qn("togglemenuitem", ay, e))(e).fold(Zb, (e => A.some(((e, t, o, n = !0) => {
                      const s = Uy({
                          iconContent: e.icon,
                          textContent: e.text,
                          htmlContent: A.none(),
              ...
              case "fancymenuitem":
                  return (e => qn("fancymenuitem", ny, e))(e).fold(Zb, (e => ((e, t) => be(aw, e.fancytype).map((o => o(e, t))))(e, o)));
              default:
      ...
      Vw = (e, t, o, n, s, r, a) => {
          ...
          return we(H(e, (e => {
              switch (e.type) {
                  ...
                  case "cardmenuitem":
                      return (e => qn("cardmenuitem", Zv, e))(e).fold(Zb, (e => A.some(((e, t, o, n) => {
                          const s = {
                              dom: Py(e.label),
                  ...
                  default:
                      return (e => qn("Autocompleter.Item", Mv, e))(e).fold(Zb, (e => A.some(((e, t, o, n, s, r, a, i = !0) => {
                          const l = Uy({
                              presets: n,
                              textContent: A.none(),
      ...
      Lw = (e, t) => {
          const o = Es(!1),
              ...
              d = n => {
                  const r = (n => {
                      ...
                      return X(n, (n => {
                          const r = n.items;
                          return Vw(r, n.matchText, ((t, s) => {
                              const r = e.selection.getRng();
                              ((e, t) => mb(Ve(t.startContainer)).map((t => {
                                  const o = e.createRng();
                          ...
                          Ph.showMenuAt(s, {
                              ...
                              return {
                                  data: Hw({
                                      ...e,
                                      movement: s,
                                      menuBehaviours: ly("auto" !== t ? [] : [Kr(((e, t) => {
                                          iy(e, 4, r.item).each((({
                                              numColumns: t,
                                              numRows: o
                                          }) => {
          ...
          ((e, t) => {
              ...
              t.on("keydown", (t => {
                  const s = t.which;
                  e.isActive() && (e.isMenuOpen() ? 13 === s ? (n().each(Rr), t.preventDefault()) : 40 === s ? (n().fold((() => {
      ...
      jw = (e, t) => lb(e) ? (e => {
          const t = qc(e, Ww),
              o = 0 === t.length ? bt(e).map(vt).map((e => qc(e, Ww))).getOr([]) : t;
          return oe(o).map((e => ({
              element: e,
              others: o.slice(1)
          })))
      ...
      Yw = (e, t) => {
          const o = {
              ...
              n = (e => {
                  const t = Ql(),
                      ...
                      s = Ds([{
                          ...
                          key: Ps(),
                          value: s => (n.cancel(), t.get().filter((e => Ze(e.target, s.target))).map((t => o.get() ? (s.prevent(), !1) : e.triggerEvent(gr(), s))))
                      }]);
                  return {
              ...
              i = tc(e, "keydown", (e => {
                  o.triggerEvent("keydown", e) ? e.kill() : o.stopBackspace && (e => e.raw.which === $m[0] && !R(["input", "textarea"], Ue(e.target)) && !$w(e.target, '[contenteditable="true"]'))(e) && e.prevent()
              })),
              l = tc(e, "focusin", (e => {
      ...
      Zw = (e, t, o, n, s, r) => {
          ...
          return a.fold((() => (r.logEventNoHandlers(t, n), Jw.complete())), (e => {
              const o = e.descHandler;
              return Aa(o)(i), i.isStopped() ? (r.logEventStopped(t, e.element, o.purpose), Jw.stopped()) : i.isCut() ? (r.logEventCut(t, e.element, o.purpose), Jw.complete()) : st(e.element).fold((() => (r.logNoParent(t, e.element, o.purpose), Jw.complete())), (n => (r.logEventResponse(t, e.element, o.purpose), Jw.resume(n))))
          }))
      },
  ...
  const uS = (e, t, o, n) => {
      ...
      _S = (e, t) => {
          ...
          Pa(o, t.invalidClass), t.notify.each((t => {
              OS(e.element) && kt(e.element, "aria-invalid", !1), t.getContainer(e).each((e => {
                  ta(e, t.validHtml)
              })), t.onValid(e)
          }))
      },
      TS = (e, t, o, n) => {
          ...
          La(s, t.invalidClass), t.notify.each((t => {
              OS(e.element) && kt(e.element, "aria-invalid", !0), t.getContainer(e).each((e => {
                  ta(e, n)
              })), t.onInvalid(e, n)
          }))
      },
      ES = (e, t, o) => t.validator.fold((() => bw(sn.value(!0))), (t => t.validate(e))),
      AS = (e, t, o) => (t.notify.each((t => {
          t.onValidate(e)
      })), ES(e, t).map((o => e.getSystem().isConnected() ? o.fold((o => (TS(e, t, 0, o), sn.error(o))), (o => (_S(e, t), sn.value(o)))) : sn.error("No longer in system"))));
  ...
  const fC = bm({
          ...
          factory: (e, t, o, n) => {
              const s = t => nm(t, e, "thumb"),
                  ...
                  p = t => {
                      ...
                      e.mouseIsDown.set(!1), o && om(t, e, "thumb").each((o => {
                          const n = d.value.get();
                          e.onChoose(t, o, n)
                      }))
                  },
                      ...
                      const s = {
                          ...
                          g = (e, t) => {
                              ...
                              (e => "hex" === e.type)(n) ? ((e, t) => {
                                  ...
                                  d(t, A.some(n)), c("red").bind((e => c("green").bind((t => c("blue").map((o => rx(e, t, o, 1))))))).each((t => {
                                      const o = ((e, t) => {
                                          const o = Qy(t);
                                          return CC.getField(e, "hex").each((t => {
          ...
          const o = fm({
              ...
              factory: o => {
                  ...
                  return {
                      ...
                      behaviours: kl([Jp("colour-picker-events", [Ur(bC, (() => {
                          const e = [c, u, m];
                          return (t, o) => {
                              const n = o.event.hex,
                                  s = (e => Tx(lx(e)))(n);
      ...
      NC = (e, t, o) => RC(e, (e => t(e.element)), ((e, t) => o(e.element, t))),
      VC = e => pu.config({
          store: {
              mode: "memory",
              initialValue: e
  ...
  const PC = (e, t) => {
      ...
      lO = (e, t, o) => {
          ...
          A.from(n.contentDocument).fold(o, (e => {
              ...
              const s = ((e, t) => {
                  ...
                  })(e, t).map((e => (o = e.scrollTop, e))).forall(aO),
                  r = () => {
      ...
      xO = (e, t, o) => {
          const n = Es(b),
              ...
              u = jh(Dw.sketch({
                  ...
                  dropdownBehaviours: kl([...e.dropdownBehaviours, ky((() => e.disabled || o.providers.isDisabled())), Sy(), IS.config({}), Kp.config({}), Jp("dropdown-events", [Ty(e, n), Ey(e, n)]), Jp(d, [Kr(((e, t) => gO(e)))]), Jp("menubutton-update-display-text", [Ur(vO, ((e, t) => {
                  ...
                  sandboxBehaviours: kl([Pp.config({
                      ...
                      onLeft: a,
                      onRight: a
                  }), Jp("dropdown-sandbox-events", [Ur(zb, ((e, t) => {
                      (e => {
                          const t = pu.getValue(e),
                              o = Pb(e).map(Wb);
                          Dw.refetch(t).get((() => {
                              const e = uw.getCoupled(t, "sandbox");
                              o.each((t => Pb(e).each((e => ((e, t) => {
      ...
      kO = (e, t) => {
          const o = ((e, t) => {
              const o = j(e, ((e, o) => (e => r(e))(o) ? "" === o ? e : "|" === o ? e.length > 0 && !wO(e[e.length - 1]) ? e.concat([SO]) : e : ve(t, o.toLowerCase()) ? e.concat([t[o.toLowerCase()]]) : e : e.concat([o])), []);
      ...
      VO = (e, t) => {
          const o = e.label.map((e => pS(e, t))),
              ...
              s = e.validation.map((e => FS.config({
      ...
      zO = (e, t) => t.getAnimationRoot.fold((() => e.element), (t => t(e))),
  ...
  const QO = Ol({
      ...
      r_ = ({
          ...
          const a = e.menu.map((e => t_(e, "tox-mbtn", r, A.none(), o))),
              i = [n_(e.title)];
          return a.each((e => i.push(e))), Wh.sketch({
              dom: {
                  tag: "div",
              ...
              buttonBehaviours: kl([...o ? [cS.config({})] : [], dh.config({
      ...
      i_ = ({
          ...
          const s = e.menu.map((e => t_(e, "tox-mbtn", n, A.none()))),
              r = [{
                  ...
                  components: [(a = "chevron-right", i = n.shared.providers.icons, ((e, t, o) => ef(e, {
                      tag: "span",
          ...
          return Wh.sketch({
              ...
              buttonBehaviours: kl([...t ? [cS.config({})] : [], Jp(a_, [Ur(Ks(), ((e, t) => {
                  const n = "ArrowRight" === t.event.raw.code,
                      s = "ArrowLeft" === t.event.raw.code;
                  n && o && t.stop(), (n || s) && mi(e.element, ".tox-tree--directory").each((o => {
                      e.getSystem().getByDom(o).each((o => {
                          !dh.isOn(o) && n || dh.isOn(o) && s ? (l(e), t.stop()) : s && !dh.isOn(o) && (mi(o.element, ".tox-tree--directory").each((e => {
      ...
      l_ = ({
          ...
          components: e.map((e => "leaf" === e.type ? r_({
              leaf: e,
              selectedId: r,
              onLeafAction: t,
              visible: o,
  ...
  const f_ = Ol({
          ...
          overrides: e => ({
              ...
              onHighlightItem: (t, o, n) => {
                  e.previewing.get() ? e.lazyTypeaheadComp.get().each((t => {
                      ...
                      e.model.populateFromBrowse && b_(e.model, t, n), _t(n.element, "id").each((e => kt(t.element, "aria-activedescendant", e)))
                  }))
              },
              onExecute: (t, o) => e.lazyTypeaheadComp.get().map((e => (Ir(e, x_(), {
                  item: o
              }), !0))),
              onHover: (t, o) => {
      ...
      k_ = bm({
          ...
          factory: (e, t, o, n) => {
              const s = (t, o, s) => {
                      ...
                      if (Xd.isOpen(r)) wm.getCurrent(r).each((e => {
                  ...
                  c = [oh.config({}), pu.config({
                      ...
                      onEnter: t => {
                          const o = uw.getCoupled(t, "sandbox"),
                              n = Xd.isOpen(o);
                          if (n && !e.previewing.get()) return i(o).bind((e => Gm.getHighlighted(e))).map((e => (Ir(t, x_(), {
                              item: e
                          }), !0))); {
      ...
      C_ = e => ({
          ...
          bindFuture: t => C_(e.bind((e => e.fold((e => bw(sn.error(e))), (e => t(e)))))),
      ...
      __ = (e, t, o = [], n, s, r) => {
          const a = t.fold((() => ({})), (e => ({
              ...
              i = {
                  buttonBehaviours: kl([ky((() => !e.enabled || r.isDisabled())), Sy(), cS.config({}), Jp("button press", [Pr("click"), Pr("mousedown")])].concat(o)),
                  eventOrder: {
      ...
      H_ = e => A.from(e.anchorTop).map((e => R_("<top>", e))).toArray(),
      L_ = e => A.from(e.anchorBottom).map((e => R_("<bottom>", e))).toArray(),
      P_ = (e, t) => {
          const o = e.toLowerCase();
          return U(t, (e => {
              var t;
      ...
      j_ = e => e.dom.checked,
      G_ = e => (t, o, n, s) => be(o, "name").fold((() => e(o, s, A.none())), (r => t.field(r, e(o, s, be(n, r))))),
      $_ = {
          bar: G_(((e, t) => ((e, t) => ({
              dom: {
                  tag: "div",
                      ...
                      behaviours: kl([Rm.config({
                          ...
                          onSetValue: (o, n) => {
                              ((o, n) => {
                                  ...
                                  ta(o.element, a.join(""))
                              })(o, n), "auto" === e.columns && iy(o, 5, "tox-collection__item").each((({
                                  numRows: e,
                                  numColumns: t
                              }) => {
          ...
          button: G_(((e, t) => ((e, t) => {
              ...
              return n = A.none(), s = aS.parts.field({
                  factory: Wh,
                  ...A_(e, A.some(o), t, [VC(""), DC()])
              }), uS(n, s, [], []);
              var n, s
          })(e, t.shared.providers))),
          checkbox: G_(((e, t, o) => ((e, t, o) => {
              const n = e => (e.element.dom.click(), A.some(!0)),
                  ...
                  a = e => ef("checked" === e ? "selected" : "unselected", {
                      tag: "span",
          ...
          colorinput: G_(((e, t, o) => ((e, t, o, n) => {
              const s = aS.parts.field({
                  ...
                  i = jh(((e, t) => Dw.sketch({
                      ...
                      lazySink: t.getSink,
                      fetch: o => fw((t => e.fetch(t))).map((n => A.from(Hw(fn(Zx(la("menu-value"), n, (t => {
                          e.onItemAction(o, t)
              ...
              return aS.sketch({
                  ...
                  fieldBehaviours: kl([Jp("form-field-events", [Ur(RS, ((t, o) => {
                      i.getOpt(t).each((e => {
          ...
          colorpicker: G_(((e, t, o) => ((e, t, o) => {
              const n = e => "tox-" + e,
                  s = MC((e => t => e.translate(zC[t]))(t), n),
                  r = jh(s.sketch({
                      dom: {
                          tag: "div",
                  ...
                  a = aS.parts.field({
                      ...
                      factory: {
                          sketch: o => xO({
                              ...
                              presets: "normal",
                              classes: [],
                              dropdownBehaviours: [cS.config({}), RC(s.map((e => e.value)), (e => Ot(e.element, _O)), ((t, o) => {
                                  EO(e.items, o).each((e => {
              ...
              const n = H(e.items, (e => ({
                  ...
                  r = aS.parts.field({
                      ...
                      selectBehaviours: kl([Rm.config({
                          disabled: () => !e.enabled || t.isDisabled()
                      }), cS.config({}), Jp("selectbox-change", [Ur(Qs(), ((t, o) => {
                          Ir(t, hS, {
                              name: e.name
                          })
                      }))])])
          ...
          sizeinput: G_(((e, t) => ((e, t) => {
              ...
              const n = la("ratio-event"),
                  ...
                  i = o => aS.parts.field({
                      ...
                      inputBehaviours: kl([Rm.config({
                          disabled: () => !e.enabled || t.isDisabled()
                      }), Sy(), cS.config({}), Jp("size-input-events", [Ur(Xs(), ((e, t) => {
                          Ir(e, n, {
                              isField1: o
                          })
                      })), Ur(Qs(), ((t, o) => {
              ...
              return FO.sketch({
                  ...
                  coupledFieldBehaviours: kl([Rm.config({
                  ...
                  }), Sy(), Jp("size-input-events2", [Ur(n, ((e, t) => {
                      ...
                      o = ((e, t) => {
                          const o = IO(e).toOptional(),
                              n = IO(t).toOptional();
                          return Se(o, n, ((e, t) => RO(e, t.unit).map((e => t.value / e)).map((e => {
                              return o = e, n = t.unit, e => RO(e, n).map((e => ({
                                  value: e * o,
                                  unit: n
                              })));
                              var o, n
          ...
          urlinput: G_(((e, t, o) => ((e, t, o, n) => {
              const s = t.shared.providers,
                  ...
                  a = {
                      ...
                      fetch: n => {
                          const s = ((e, t, o) => {
                                  ...
                                  return o.getLinkInformation().fold((() => []), (t => {
                                      ...
                                      return "file" === e ? (s = [n, P_(a, V_(t)), P_(a, q([H_(t), z_(t), L_(t)]))], j(s, ((e, t) => 0 === e.length || 0 === t.length ? e.concat(t) : e.concat(F_, t)), [])) : n;
                                      var s
                                  }))
                              })(e.filetype, n, o),
                      ...
                      typeaheadBehaviours: kl([...o.getValidationHandler().map((t => FS.config({
                          getRoot: e => rt(e.element),
                      ...
                      }), cS.config({}), Jp("urlinput-events", [Ur(Zs(), (t => {
                          const o = $a(t.element),
                              n = o.trim();
                  ...
                  }, s.icons))("invalid", A.some(U_), "warning")),
                  d = jh({
                      dom: {
                          tag: "div",
          ...
          customeditor: G_((e => {
              ...
              return {
                  ...
                  }))]), RC(A.none(), (() => t.get().fold((() => n.get().getOr("")), (e => e.getValue()))), ((e, o) => {
                      t.get().fold((() => n.set(o)), (e => e.setValue(o)))
                  })), DC()]),
                  components: [o.asSpec()]
              }
          })),
          htmlpanel: G_((e => "presentation" === e.presets ? oS.sketch({
              dom: {
                  tag: "div",
                  classes: ["tox-form__group"],
                  innerHtml: e.html
          ...
          imagepreview: G_(((e, t, o) => ((e, t) => {
              ...
              return {
                  ...
                  components: [s.asSpec()],
                  behaviours: kl([DC(), RC(a, (() => o.get()), ((e, t) => {
                      const r = {
                          url: t.url
                      };
                      ...
                      n.getOpt(e).each((o => {
                          const n = o.element;
                          var s;
                          t.url !== Ot(n, "src") && (kt(n, "src", t.url), Pa(e.element, "tox-imagepreview__loaded")), a(), (s = n, new Promise(((e, t) => {
                              const o = () => {
                                      r(), e(s)
                                  },
          ...
          tree: G_(((e, t) => ((e, t) => {
              const o = e.onLeafAction.getOr(b),
                  ...
                  i = la("tree-id"),
                  l = (n, s) => e.items.map((e => "leaf" === e.type ? r_({
                      leaf: e,
                      selectedId: n,
                      onLeafAction: o,
                      visible: !0,
      ...
      X_ = (e, t, o, n) => {
          const s = fn(n, {
              shared: {
                  interpreter: t => Y_(e, t, o, s)
              }
          });
          return Y_(e, t, o, s)
      },
      Y_ = (e, t, o, n) => be($_, t.type).fold((() => (console.error(`Unknown factory type "${t.type}", defaulting to container: `, t), t)), (s => s(e, t, o, n))),
      ...
      sT = (e, t, o) => zi(eT(e, t), oT(e, t), o.insetSouthwest(), Wi(), "southwest", Ki(e, {
          right: 0,
          bottom: 3
      }), J_),
      rT = (e, t, o) => zi(Z_(e), oT(e, t), o.insetSoutheast(), Ui(), "southeast", Ki(e, {
          left: 1,
          bottom: 3
      }), J_),
      aT = (e, t, o) => zi(eT(e, t), tT(e), o.insetNorthwest(), Pi(), "northwest", Ki(e, {
          right: 0,
          top: 2
      }), J_),
      iT = (e, t, o) => zi(Z_(e), tT(e), o.insetNortheast(), Li(), "northeast", Ki(e, {
          left: 1,
          top: 2
      }), J_),
      lT = (e, t, o) => zi(Q_(e, t), tT(e), o.insetNorth(), ji(), "north", Ki(e, {
          top: 2
      }), J_),
      cT = (e, t, o) => zi(Q_(e, t), oT(e, t), o.insetSouth(), Gi(), "south", Ki(e, {
          bottom: 3
      }), J_),
      dT = (e, t, o) => zi(eT(e, t), nT(e, t), o.insetEast(), qi(), "east", Ki(e, {
          right: 0
      }), J_),
      uT = (e, t, o) => zi(Z_(e), nT(e, t), o.insetWest(), $i(), "west", Ki(e, {
          left: 1
      }), J_),
      mT = e => {
          switch (e) {
      ...
      GT = e => {
          ...
          return HT("header", null !== (t = LT(e)) && void 0 !== t ? t : "", "#" + o, (e => UT(e) ? parseInt(e.nodeName.substr(1), 10) : 0)(e), (() => {
              e.id = o
          }))
      },
      $T = e => {
      ...
      rE = e => ({
          getHistory: QT,
          addToHistory: eE,
          getLinkInformation: () => (e => Vf(e) ? A.some({
      ...
      fE = T,
      bE = x([]);
  var vE, yE = Object.freeze({
      __proto__: null,
      setup: hE,
      isDocked: fE,
      getBehaviours: bE
  });
  const xE = e => (xe(Nt(e, "position"), "fixed") ? A.none() : at(e)).orThunk((() => {
          const t = Re("span");
          return st(e).bind((e => {
              zo(e, t);
              const o = at(t);
      ...
      wE = e => xE(e).map(Xt).getOrThunk((() => $t(0, 0))),
      SE = (e, t) => {
          const o = e.element;
      ...
      AE = (e, t, o) => o.getInitialPos().map((o => {
          const n = ((e, t) => {
      ...
      DE = (e, t, o) => o.getInitialPos().bind((n => {
          var s;
      ...
      FE = (e, t, o) => {
          const n = e.element;
          return xe(Nt(n, "position"), "fixed") ? ((e, t, o) => ((e, t, o) => AE(e, t, o).filter((({
              box: e
          }) => ((e, t, o) => Y(e, (e => {
              switch (e) {
                  case "bottom":
              ...
              box: t
          }) => DE(e, t, o))))(e, t, o).orThunk((() => t.optScrollEnv.bind((n => AE(e, t, o))).bind((({
              box: e,
              location: o
          }) => {
              const n = en(),
      ...
      LE = e => (t, o, n) => {
          ...
          ((e, t, o, n) => {
              ...
              return "bottom" === a.location || "top" === a.location ? (((e, t, o, n, s) => {
                  n.getInitialPos().fold((() => ME(e, t, o, n, s)), (() => b))
  ...
  var WE = Object.freeze({
      ...
      GE = [vs("contextual", [rs("fadeInClass"), rs("fadeOutClass"), rs("transitionClass"), is("lazyContext"), Di("onShow"), Di("onShown"), Di("onHide"), Di("onHidden")]), Os("lazyViewport", (() => ({
          bounds: en(),
          optScrollEnv: A.none()
  ...
  const $E = Ol({
      ...
      tA = (e, t) => {
          const o = Ql(),
              ...
              r = t => {
                  e.inline || ZE(t), eA(e, $E.isDocked(t)), t.getSystem().broadcastOn([Kd()], {}), n().each((e => e.getSystem().broadcastOn([Kd()], {})))
              },
          ...
          return [oh.config({}), $E.config({
              contextual: {
                  ...
                  onShown: e => {
                      s((e => ja(e, [XE.transitionClass, XE.fadeInClass]))), o.get().each((t => {
                          ((e, t) => {
                              const o = et(t);
                  ...
                  onHide: e => {
                      ((e, t) => Rl(e).orThunk((() => t().toOptional().bind((e => Rl(e.element))))))(e.element, n).fold(o.clear, o.set), s((e => QE(e, !1)))
                  },
                  onHidden: () => {
              ...
              lazyViewport: t => jw(e, t.element).fold((() => {
                  const o = en(),
                      n = Mf(e),
                      s = o.y + (JE(t, "top") ? n : 0),
  ...
  const nA = Dn([tv, ns("items", Fn([Rn([ov, ds("items", Hn)]), Hn]))].concat(Dv)),
      sA = [ps("text"), ps("tooltip"), ps("icon"), xs("search", !1, Fn([Ln, Dn([ps("placeholder")])], (e => d(e) ? e ? A.some({
          placeholder: A.none()
              ...
              setMenus: (e, o) => {
                  const n = H(o, (e => {
                      const o = {
                          ...
                          n = aA(o).mapError((e => Kn(e))).getOrDie();
  ...
  const cA = "container",
      ...
      mA = (e, t) => {
          const o = t => am(e),
              ...
              a = n(((e, t) => {
                  if (s(e)) {
                      const o = e.element;
                      Dt(o, "display", "none"), kt(o, "aria-hidden", "true"), Ir(e, Tr(), {
                          name: t,
                          visible: !1
                      })
                  }
              ...
              l = n(((e, t) => {
                  if (!s(e)) {
                      const o = e.element;
                      Ht(o, "display"), Et(o, "aria-hidden"), Ir(e, Tr(), {
                          name: t,
                          visible: !0
                      })
                  }
      ...
      bA = (e, t) => {
          ...
          return H(o, (t => {
              ...
              return e.slot(t.name, {
                  ...
                  behaviours: ly([Ty(t, n), Ey(t, n), Ur(Tr(), ((e, t) => {
                      const n = t.event,
      ...
      xA = e => wm.getCurrent(e).bind((e => QO.isGrowing(e) || QO.hasGrown(e) ? wm.getCurrent(e).bind((e => G(pA.getSlotNames(e), (t => pA.isShowing(e, t))))) : A.none())),
      wA = la("FixSizeEvent"),
      SA = la("AutoSizeEvent");
  var kA = Object.freeze({
          ...
          block: (e, t, o, n) => {
              ...
              Kp.append(s, ai(i)), i.hasConfigured(Pp) && t.focus && Pp.focusIn(i), o.isBlocked() || t.onBlock(e), o.blockWith((() => Kp.remove(s, i)))
          },
          unblock: (e, t, o) => {
  ...
  const OA = Ol({
      ...
      EA = (e, t, o) => {
          const n = Es(!1),
              ...
              r = o => {
                  var s;
                  n.get() && (!(e => "focusin" === e.type)(s = o) || !(s.composed ? oe(s.composedPath()) : A.from(s.target)).map(Ve).filter(Ge).exists((e => Ua(e, "mce-pastebin")))) && (o.preventDefault(), TA(t()), e.editorManager.setActive(e))
              };
          ...
          const a = s => {
              s !== n.get() && (n.set(s), ((e, t, o, n) => {
                  ...
                  }))(n)), Ht(s, "display"), Et(s, "aria-hidden"), e.hasFocus() && TA(t);
                  else {
      ...
      RA = x([Ai(["overflowToggledClass"]), fs("getOverflowBounds"), os("lazySink"), es("overflowGroups", (() => Es([]))), Di("onOpened"), Di("onClosed")].concat(IA())),
      NA = x([Uu({
          factory: pE,
          schema: mE(),
          name: "primary"
          ...
          factory: {
              sketch: e => {
                  ...
                  return {
                      ...
                      dom: {
                          tag: "div",
                          classes: [t ? "tox-view__toolbar" : "tox-view__header", ...fM || bM ? ["tox-view--mobile", "tox-view--scrolling"] : []]
                      },
  ...
  const yM = (e, t, o) => pe(t, ((t, n) => {
          ...
          return e.slot(n, vM.sketch({
              ...
              viewConfig: s,
              components: [...s.buttons.length > 0 ? [vM.parts.header({
                  buttons: s.buttons,
                  providers: o
              })] : [], vM.parts.pane({})]
          }))
      ...
      factory: (e, t) => {
          const o = {
              ...
              toggleView: (e, t, o, n) => wm.getCurrent(e).exists((s => {
                  ...
                  return i && (pA.hideAllSlots(s), a ? ((e => {
                      const t = e.element;
                      Dt(t, "display", "none"), kt(t, "aria-hidden", "true")
                  })(e), t()) : (o(), (e => {
                      const t = e.element;
                      Ht(t, "display"), Et(t, "aria-hidden")
                  })(e), pA.showSlot(s, n), ((e, t) => {
                      SM(e, t, vM.getOnShow)
                  })(s, n)), r.each((e => ((e, t) => SM(e, t, vM.getOnHide))(s, e)))), i
              }))
          };
          return {
              uid: e.uid,
      ...
      MM = iE.optional({
          factory: {
              sketch: e => ({
                  ...
                  behaviours: kl([BC(0), Jp("sidebar-sliding-events", [Ur(wA, ((e, t) => {
  ...
  var IM = bm({
      ...
      factory: (e, t, o) => {
          ...
          const s = {
              ...
              setSidebar: (t, o, n) => {
                  aE.getPart(t, e, "sidebar").each((e => ((e, t, o) => {
              ...
              toggleSidebar: (t, o) => {
                  aE.getPart(t, e, "sidebar").each((e => ((e, t) => {
              ...
              isToolbarDrawerToggled: t => aE.getPart(t, e, "toolbar").bind((e => A.from(e.getApis().isOpen).map((t => t(e))))).getOr(!1),
              getThrobber: t => aE.getPart(t, e, "throbber"),
              focusToolbar: t => {
                  aE.getPart(t, e, "toolbar").orThunk((() => aE.getPart(t, e, "multiple-toolbar"))).each((e => {
                      Pp.focusIn(e)
                  }))
              },
              setMenubar: (t, o) => {
              ...
              toggleView: (t, o) => aE.getPart(t, e, "viewWrapper").exists((e => kM.toggleView(e, (() => s.showMainView(t)), (() => s.hideMainView(t)), o))),
              whichView: t => aE.getPart(t, e, "viewWrapper").bind(kM.whichView).getOrNull(),
              hideMainView: t => {
                  n = s.isToolbarDrawerToggled(t), n && s.toggleToolbarDrawer(t), aE.getPart(t, e, "editorContainer").each((e => {
                      const t = e.element;
                      Dt(t, "display", "none"), kt(t, "aria-hidden", "true")
                  }))
              },
              showMainView: t => {
                  n && s.toggleToolbarDrawer(t), aE.getPart(t, e, "editorContainer").each((e => {
                      const t = e.element;
                      Ht(t, "display"), Et(t, "aria-hidden")
                  }))
              }
  ...
  const RM = {
      ...
      UM = (e, t) => {
          const o = Jf(t);
          return o && t.contentCSS.push(o + (e ? "/content.inline" : "/content") + ".min.css"), !Yf(t) && r(o) ? Promise.all([LM(t, o), PM(t, o)]).then(zM(t), ((e, t) => () => ((e, t) => {
  ...
  const YM = (e, t, o) => {
          const n = (s = ((e, t) => t === XM.SemiColon ? e.replace(/;$/, "").split(";") : e.split(" "))(e.options.get(t), o), H(s, (e => {
              let t = e,
                  o = e;
              const n = e.split("=");
      ...
      rD = (e, t) => A.from(sD.exec(e)).bind((e => {
          const o = Number(e[1]),
              n = e[2];
          return ((e, t) => N(t, (t => N(nD[t], (t => e === t)))))(n, t) ? A.some({
              value: o,
              unit: n
          }) : A.none()
      })),
      ...
      mD = (e, t) => {
          ...
          return {
              ...
              onAction: xx(e),
              updateText: t => {
                  const n = e => ET(e) ? X(e.items, n) : AT(e) ? [{
                          title: e.title,
                          format: e.format
                      }] : [],
                      s = X(BT(e), n),
      ...
      SD = (e, t, o, n, s) => {
          ...
          return {
              ...
              buttonBehaviours: kl([Oy(s.isDisabled), Sy(), Jp(uO, [Kr(((e, t) => gO(e))), Ur(vO, ((e, t) => {
                  r.bind((t => t.getOpt(e))).each((e => {
      ...
      kD = (e, t, o) => {
          ...
          return Wh.sketch({
              ...
              buttonBehaviours: {
                  ...
                  }))), Ty(t, s), Ey(t, s)]), Oy((() => !e.enabled || o.isDisabled())), Sy()].concat(t.toolbarButtonBehaviours)),
      ...
      AD = {
          ...
          splitbutton: ED((e => qn("SplitButton", iA, e)), ((e, t) => ((e, t) => {
              const o = e => ({
                      isEnabled: () => !Rm.isDisabled(e),
                      setEnabled: t => Rm.set(e, !t),
                      setIconFill: (t, o) => {
                      ...
                      setText: t => pi(e.element, "span").each((o => e.getSystem().getByDom(o).each((e => Ir(e, vO, {
                          text: t
                      }))))),
                      setIcon: t => pi(e.element, "span").each((o => e.getSystem().getByDom(o).each((e => Ir(e, yO, {
                          icon: t
                      })))))
                  }),
                  n = Es(b),
              ...
              return bD.sketch({
                  ...
                  onItemExecute: (e, t, o) => {},
                  splitDropdownBehaviours: kl([Cy(t.providers.isDisabled), Sy(), Jp("split-dropdown-events", [Kr(((e, t) => gO(e))), Ur(wD, oh.focus), Ty(s, n), Ey(s, n)]), IS.config({})]),
                  eventOrder: {
                  ...
                  f = jh({
                      ...
                      components: [Vb.sketch({
                          inputBehaviours: kl([Rm.config({}), Jp(i, [Ty({
                              ...
                              getApi: r
                          }, a)]), Jp("input-update-display-text", [Ur(vO, ((e, t) => {
      ...
      DD = (e, t, o, n) => {
          const s = (e => {
              ...
              a = H(s, (s => {
                  const r = X(s.items, (s => 0 === s.trim().length ? [] : ((e, t, o, n, s, r) => be(t, o.toLowerCase()).orThunk((() => r.bind((e => re(e, (e => be(t, e + o.toLowerCase()))))))).fold((() => be(MD, o.toLowerCase()).map((t => t(e, s)))), (t => "grouptoolbarbutton" !== t.type || n ? ((e, t, o) => be(AD, e.type).fold((() => (console.error("skipping button defined by", e), A.none())), (n => A.some(n(e, t, o)))))(t, s, e) : (console.warn(`Ignoring the '${o}' toolbar button. Group toolbar buttons are only supported when using floating toolbar mode and cannot be nested.`), A.none()))))(e, t.buttons, s, t.allowToolbarGroups, o, n).toArray()));
                  return {
  ...
  var RD = Object.freeze({
      ...
      render: async (e, t, o, n, s) => {
          const {
              mainUi: r,
              uiMotherships: a
          } = t, i = Es(0), l = r.outerContainer;
          await WM(e);
          const d = Ve(s.targetNode),
              u = ft(ht(d));
          Rd(d, r.mothership), ((e, t, o) => {
              lb(e) && Rd(o.mainUi.mothership.element, o.popupUi.mothership), Id(t, o.dialogUi.mothership)
          })(e, u, t), e.on("PostRender", (() => {
              IM.setSidebar(l, o.sidebar, $f(e)), BD(e, t, o, n), i.set(e.getWin().innerWidth), IM.setMenubar(l, VM(e, o)), IM.setViews(l, o.views), ((e, t) => {
                  const {
                      uiMotherships: o
                  } = t, n = e.dom;
                  let s = e.getWin();
          ...
          wy(e, t), e.addCommand("ToggleSidebar", ((t, o) => {
          ...
          const g = Cf(e);
          g !== nf.sliding && g !== nf.floating || e.on("ResizeWindow ResizeEditor ResizeContent", (() => {
  ...
  const ND = e => /^[0-9\.]+(|px)$/i.test("" + e) ? A.some(parseInt("" + e, 10)) : A.none(),
      ...
      UD = (e, t, o, n, s) => {
          const {
              mainUi: r,
              uiMotherships: a
          } = o, i = rf.DOM, l = sb(e), c = ib(e), d = bf(e).or(HD(e)), u = n.shared.header, m = u.isPositionedAtTop, g = Cf(e), p = g === PD.sliding || g === PD.floating, h = Es(!1), f = () => h.get() && !e.removed, b = e => p ? e.fold(x(0), (e => e.components().length > 1 ? Wt(e.components()[1].element) : 0)) : 0, v = () => {
              L(a, (e => {
                  e.broadcastOn([Kd()], {})
              }))
          }, y = o => {
              ...
              p && IM.refreshToolbar(r.outerContainer), l || (o => {
                  s.on((n => {
                      const s = IM.getToolbar(r.outerContainer),
                          ...
                          i = Jo(t),
                          {
                              top: l,
                              left: c
                          } = ((e, t) => lb(e) ? xE(t) : A.none())(e, r.outerContainer.element).fold((() => ({
          ...
          return {
              ...
              isPositionedAtTop: m,
              show: () => {
                  h.set(!0), Dt(r.outerContainer.element, "display", "flex"), i.addClass(e.getBody(), "mce-edit-focus"), L(a, (e => {
                      Ht(e.element, "display")
                  })), w(), lb(e) ? y((e => $E.isDocked(e) ? $E.reset(e) : $E.refresh(e))) : y($E.refresh)
              },
              hide: () => {
                  h.set(!1), Dt(r.outerContainer.element, "display", "none"), i.removeClass(e.getBody(), "mce-edit-focus"), L(a, (e => {
                      Dt(e.element, "display", "none")
                  }))
              },
              update: y,
  ...
  var jD = Object.freeze({
      ...
      render: async (e, t, o, n, s) => {
          const {
              mainUi: r
          } = t, a = Ql(), i = Ve(s.targetNode), l = UD(e, i, t, n, a), c = Af(e);
          await jM(e);
          const d = () => {
              if (a.isSet()) return void l.show();
              a.set(IM.getHeader(r.outerContainer).getOrDie());
              const s = rb(e);
              lb(e) ? (Rd(i, r.mothership), Rd(i, t.popupUi.mothership)) : Id(s, r.mothership), Id(s, t.dialogUi.mothership), BD(e, t, o, n), IM.setMenubar(r.outerContainer, VM(e, o)), l.show(), ((e, t, o, n) => {
                  const s = Es(WD(t, o.isPositionedAtTop())),
                      r = n => {
                          const {
                              pos: r,
                              bounds: a
                          } = WD(t, o.isPositionedAtTop()), {
                              pos: i,
                              bounds: l
                  ...
                  n || (e.on("activate", o.show), e.on("deactivate", o.hide)), e.on("SkinLoaded ResizeWindow", (() => o.update($E.reset))), e.on("NodeChange keydown", (e => {
                  ...
                  })), lb(e) && e.on("ElementScroll", (e => {
                      o.update($E.refresh)
                  }));
                  const l = Zl();
                  l.set(oc(Ve(e.getBody()), "load", (e => r(e.raw)))), e.on("remove", (() => {
                      l.clear()
                  }))
  ...
  const GD = "contexttoolbar-hide",
      ...
      qD = (e, t) => {
          const o = e.label.fold((() => ({})), (e => ({
              ...
              s = ((e, t, o) => {
                  const n = H(t, (t => jh(((e, t, o) => (e => "contextformtogglebutton" === e.type)(t) ? ((e, t, o) => {
                      const {
                          primary: n,
                          ...s
                      } = t.original, r = Xn(Nv({
      ...
      cB = (e, t, o, n) => {
          const s = n.backstage,
              ...
              d = ri((e => {
                  ...
                  return Ph.sketch({
                      ...
                      inlineBehaviours: kl([Jp("context-toolbar-events", [Yr(or(), ((e, t) => {
                          ...
                          const s = Jt(o);
                          Dt(o, "width", n + "px"), Ph.getContent(e).each((e => {
                          ...
                          mode: "special",
                          onEscape: o => ne(t.get()).fold((() => e.onEscape()), (e => (Fr(o, rB), A.some(!0))))
                      })]),
              ...
              g = () => {
                  if (m()) {
                      const t = u(),
                          o = xe(c.get(), "node") ? ((e, t) => t.filter((e => yt(e) && je(e))).map(Zo).getOrThunk((() => YD(e))))(e, i.get()) : YD(e);
                      return t.height <= 0 || !XD(o, t, .01)
                  }
                  return !0
              },
              p = () => {
              ...
              y = t => {
                  const {
                      ...
                      ...o,
                      ...v().formNavigators
                  }, a = Cf(e) === nf.scrolling ? nf.scrolling : nf.default, i = q(H(t, (t => "contexttoolbar" === t.type ? ((t, o) => DD(e, {
                      buttons: t,
                      toolbar: o.items,
                      allowToolbarGroups: !1
                  }, n.backstage, A.some(["form:"])))(s, t) : ((e, t) => qD(e, t))(t, r.providers))));
                  return lM({
                      type: a,
              ...
              x = (t, n) => {
                  ...
                  c.set(p), l.set(1);
                  const b = d.element;
                  Ht(b, "display"), (e => xe(Se(e, i.get(), Ze), !0))(n) || (Pa(b, lB), Sd.reset(o, d)), Ph.showWithinBounds(d, f(s), {
                      anchor: h,
                      transition: {
                          classes: [lB],
                          mode: "placement"
          ...
          let w = !1;
          const S = PC((() => {
              !e.hasFocus() || e.removed || w || (Ua(d.element, lB) ? S.throttle() : ((e, t) => {
                  ...
                  return (e => !n(e) && !Qe(o, e))(s) ? A.none() : ((e, t, o) => {
                      ...
                      if (Ge(e)) {
                          const {
                              contextToolbars: t,
                              contextForms: n
                          } = oB(e, o.inNodeScope), s = n.length > 0 ? n : (e => {
                              if (e.length <= 1) return e; {
          ...
          e.on("init", (() => {
              e.on("remove", p), e.on("ScrollContent ScrollWindow ObjectResized ResizeEditor longpress", h), e.on("click keyup focus SetContent", S.throttle), e.on(GD, p), e.on("contexttoolbar-show", (t => {
                  const o = v();
      ...
      uB = e => {
          dB(e, (e => ({
              ...
              icon: "line-height",
              getOptions: Zf,
              hash: e => ((e, t) => rD(e, ["fixed", "relative", "empty"]).map((({
                  value: e,
                  unit: t
              }) => e + t)))(e).getOr(e),
              display: w,
      ...
      fB = (e, t) => yx(e, "Undo Redo AddUndo TypingUndo ClearUndos SwitchMode", (o => {
          o.setEnabled(!e.mode.isReadOnly() && e.undoManager[t]())
      })),
      bB = e => yx(e, "VisualAid", (t => {
      ...
      _B = (e, t) => "contextmenu" === t.type || "longpress" === t.type ? e.inline ? (e => {
          if (OB(e)) {
              const t = e.touches[0];
                  ...
                  ((e, t, o, n, s, r, a) => {
                      ...
                      CO(o, pb.CLOSE_ON_EXECUTE, n, {
                          ...
                          Ph.showMenuWithinBounds(s, {
                              ...
                              data: o,
                              type: "horizontal"
                          }, (() => A.some(KD(e, n.shared, "node" === r ? "node" : "selection")))), e.dispatch(GD)
                      }))
                  })(e, t, a, n, s, r, !(c || i || l && d))
              };
          if ((l || i) && "node" !== r) {
      ...
      NB = (e, t) => {
          ...
          const o = ne(e).filter((e => !FB(e))).fold((() => []), (e => [IB]));
          return e.concat(o).concat(t).concat([IB])
      },
      VB = (e, t) => !(e => "longpress" === e.type || ve(e, "touches"))(t) && (2 !== t.button || t.target === e.getBody() && "" === t.pointerType),
      ...
      QB = (e, t, o, n, s, r) => {
          const a = ((e, t, o, n) => ((e, t) => {
              ...
              })(e, t).fold((() => o), (e => JB(e.left + n.left, e.top + n.top))))(e, t, o, n),
      ...
      aF = e => {
          (e => {
              st(e.element).filter(Ge).each((e => {
                  _t(e, sF).fold((() => Ht(e, "z-index")), (t => Dt(e, "z-index", t))), Et(e, sF)
              }))
          })(e), e.getSystem().removeFromGui(e)
      },
      iF = (e, t, o) => e.getSystem().build(oS.sketch({
          dom: {
              styles: {
                  left: "0px",
                  top: "0px",
  ...
  const cF = [ys("useFixed", T), os("blockerClass"), ys("getTarget", w), ys("onDrag", b), ys("repositionTarget", !0), ys("onDrop", b), Os("getBounds", en), lF],
      dF = e => {
          return (t = Nt(e, "left"), o = Nt(e, "top"), n = Nt(e, "position"), t.isSome() && o.isSome() && n.isSome() ? A.some(((e, t, o) => ("fixed" === o ? JB : YB)(parseInt(e, 10), parseInt(t, 10)))(t.getOrDie(), o.getOrDie(), n.getOrDie())) : A.none()).getOrThunk((() => {
              const t = Xt(e);
                  ...
                  if (t.repositionTarget) {
                      const r = et(e.element),
                          ...
                          c = ((e, t, o, n, s, r, a) => ((e, t, o, n, s) => {
                              ...
                              const e = (t = o, a = r.left, i = r.top, t.fold(((e, t) => YB(e + a, t + i)), ((e, t) => KB(e + a, t + i)), ((e, t) => JB(e + a, t + i))));
                              var t, a, i;
                              const l = jB(e, n, s);
  ...
  const fF = (e, t, o) => [Ur(Ws(), ((n, s) => {
          ...
          const r = () => gF(n, A.some(l), e, t),
              ...
              l = iF(n, e.blockerClass, (e => Hr([Ur(Ws(), e.forceDrop), Ur($s(), e.drop), Ur(js(), ((t, o) => {
                  e.move(o.event)
              })), Ur(Gs(), e.delayDrop)]))(i));
          o(n), rF(n, l)
      }))],
  ...
  const yF = (e, t, o) => {
          ...
          return [Ur(Hs(), ((r, a) => {
              ...
              const i = () => s(r),
                  ...
                  c = iF(r, e.blockerClass, (e => Hr([Ur(Hs(), e.forceDrop), Ur(Ps(), e.drop), Ur(Us(), e.drop), Ur(Ls(), ((t, o) => {
                      e.move(o.event)
                  }))]))(l));
              n.set(c), o(r), rF(r, c)
          })), Ur(Ls(), ((o, n) => {
  ...
  const OF = Tl({
      ...
      AF = (e, t) => {
          ...
          Do().deviceType.isTouch() && (e.on("TableSelectionChange", (e => {
              s.get() || (Ad(t, g), Ad(t, p), s.set(!0)), r.set(e.start), a.set(e.finish), e.otherCells.each((t => {
      ...
      MF = (e, t, o) => {
          ...
          return {
              ...
              }), Sy(), cS.config({}), Kp.config({}), Jp("elementPathEvents", [Kr(((t, n) => {
                  e.shortcuts.add("alt+F11", "focus statusbar elementpath", (() => Pp.focusIn(t))), e.on("NodeChange", (n => {
                      const r = (t => {
                              const o = [];
                              let n = t.length;
                              for (; n-- > 0;) {
  ...
  const BF = (e, t, o) => {
      ...
      IF = (e, t) => {
          const o = () => {
              ...
              return s && o.push(MF(e, {}, t)), n && o.push((() => {
                  const e = Iy("Alt+0");
                  return {
                      dom: {
                          tag: "div",
              ...
              components: (() => {
                  const n = o(),
                      s = ((e, t) => {
                          ...
                          const n = o === DF.Both ? "Press the arrow keys to resize the editor." : "Press the Up and Down arrow keys to resize the editor.";
      ...
      NF = (e, t) => {
          const o = e.inline,
              ...
              p = () => r.mainUi.get().map((e => e.outerContainer)).bind(IM.getHeader),
          ...
          return {
              popups: {
                  backstage: y.popup,
                  getMothership: () => RF("popups", l)
              },
              dialogs: {
                  backstage: y.dialog,
                  getMothership: () => RF("dialogs", i)
              },
              renderUI: () => {
                  const o = x(),
                      a = (() => {
                  ...
                  return (t => {
                      ...
                      })), e.addQueryStateHandler("ToggleToolbarDrawer", (() => IM.isToolbarDrawerToggled(f))), ((e, t, o) => {
                          const n = (e, n) => {
                                  L([t, ...o], (t => {
                              ...
                              v = oc(b, "scroll", (o => {
                                  requestAnimationFrame((() => {
                                      if (null != e.getContainer()) {
                                          const s = jw(e, t.element).map((e => [e.element, ...e.others])).getOr([]);
                      ...
                      })(e, o.mothership, a), s.setup(e, y.popup.shared, p), vB(e, y.popup), HB(e, y.popup.shared.getSink, y.popup), (e => {
                          const {
                              sidebars: t
      ...
      JI = Dn(KI),
      ZI = KI.concat([ds("children", Zn(0, (() => jn("type", {
          directory: QI,
          leaf: JI
      }))))]),
      QI = Dn(ZI),
      ...
      aR = e => Qn("items", "items", {
          tag: "required",
          process: {}
      }, Bn(Gn((t => qn(`Checking item of ${e}`, iR, t).fold((e => sn.error(Kn(e))), (e => sn.value(e))))))),
      iR = En((() => {
          return jn("type", {
              alertbanner: KF,
      ...
      wR = e => {
          const t = (e => U(vR(e), yR))(e),
              o = X(t, (e => (e => A.from(xR[e.type]))(e).fold((() => []), (t => [ns(e.name, t)]))));
          return Dn(o)
      },
      SR = e => {
          var t;
      ...
      $R = (e, t, o) => {
              ...
              l = (e => {
                  const t = Ql(),
                      o = [Kr((o => {
                          const n = o.element;
                          WR(n).each((s => {
                              Dt(s, "visibility", "hidden"), o.getSystem().getByDom(s).toOptional().each((o => {
                          ...
                          WR(n).each((e => {
                              ...
                              s.forall((e => r > e)) ? (t.set(r), UR(n, e, t)) : s.each((t => {
                                  PR(e, t)
          ...
          return LR.sketch({
              ...
              tabSectionBehaviours: kl([Jp("tabpanel", l.extraEvents), Pp.config({
                  ...
                  find: e => oe(LR.getViewItems(e))
              }), RC(A.none(), (e => (e.getSystem().broadcastOn([jR], {}), n.get())), ((e, t) => {
  ...
  var dN, uN = wN(Array.prototype.forEach),
                  ...
                  if (!L[s] || G[s]) {
                      ...
                      if (se && !ie[s]) {
                          var r = y(e) || e.parentNode,
                              a = v(e) || e.childNodes;
                          if (a && r)
                              for (var i = a.length - 1; i >= 0; --i) r.insertBefore(f(a[i], !0), b(e))
                      }
                      return Ee(e), !0
                  }
  ...
  const $N = e => GN().sanitize(e),
      ...
      YN = (e, t) => LF.parts.close(Wh.sketch({
          dom: {
              tag: "button",
      ...
      JN = (e, t) => LF.parts.body({
          ...
          components: [{
              ...
              components: [{
                  dom: _A(`<p>${$N(t.translate(e))}</p>`)
              }]
          }]
      }),
      ZN = e => LF.parts.footer({
          dom: {
              tag: "div",
      ...
      dV = (e, t) => [$r(Xs(), qC), e(fS, ((e, o, n, s) => {
          Il(ht(s.element)).fold(b, Bl), t.onClose(), o.onClose()
      })), e(bS, ((e, t, o, n) => {
          t.onCancel(e), Fr(n, fS)
      })), Ur(wS, ((e, o) => t.onUnblock())), Ur(xS, ((e, o) => t.onBlock(o.event)))],
      uV = (e, t, o) => {
          const n = (t, o) => Ur(t, ((t, n) => {
              ...
              s = (e, t) => {
                  TR.getState(e).get().each((o => {
                      t(o.internalDialog, e)
                  }))
              };
          return [...dV(n, t), n(yS, ((e, t) => t.onSubmit(e))), n(hS, ((e, t, o) => {
              t.onChange(e, {
                  name: o.name
              })
          })), n(vS, ((e, t, n, s) => {
          ...
          const n = t => {
              ...
              s = {
                  ...
                  setData: t => {
                      n((n => {
                          const r = s.getData(),
                              ...
                              i = ((e, t) => {
                                  const o = e.getRoot();
                                  return TR.getState(o).get().map((e => Xn(qn("data", e.dataValidator, t)))).getOr(t)
                              })(e, a),
                              l = e.getFormWrapper();
                          pu.setValue(l, i), le(o, ((e, t) => {
                              ve(a, t) && e.set(a[t])
                          }))
                      }))
                  },
                  ...
                  showTab: t => {
                      n((o => {
                          const n = e.getBody();
                          TR.getState(n).get().exists((e => e.isTabPanel())) && wm.getCurrent(n).each((e => {
                              LR.showTab(e, t)
                          }))
                      }))
                  },
                  redial: r => {
                      n((n => {
                          ...
                          n.getSystem().broadcastOn([`${YC}-${a}`], i), n.getSystem().broadcastOn([`${KC}-${a}`], i.internalDialog), n.getSystem().broadcastOn([`${JC}-${a}`], i.internalDialog), n.getSystem().broadcastOn([`${ZC}-${a}`], {
                              ...i.internalDialog,
                              buttons: l
      ...
      bV = (e, t, o, n = !1) => {
          const s = la("dialog"),
              ...
              d = jh(((e, t, o, n, s) => qR(e, t, A.some(o), n, s))({
                  body: i.body,
                  initialData: i.initialData
              }, s, a, o, n)),
              u = lV(i.buttons),
              m = cV(u),
              g = Ce(0 !== u.length, jh(((e, t, o) => gV(e, t, o))({
                  buttons: u
              }, s, o))),
              p = uV((() => b), {
                  onBlock: e => {
  ...
  const yV = ["insertContent", "setContent", "execCommand", "close", "block", "unblock"],
      ...
      CV = (e, t, o) => t && o ? [] : [$E.config({
          ...
          modes: ["top"],
          lazyViewport: t => jw(e, t.element).map((e => ({
              bounds: Gw(e),
              optScrollEnv: A.some({
                  currentScrollTop: e.element.dom.scrollTop,
                  scrollElmTop: Xt(e.element).top
          ...
          const t = e.editor,
              ...
              i = (o, n, s, r) => kR.open(((o, a, i) => {
                  const l = SV(a, i),
                      ...
                      g = ri(Ph.sketch({
                          ...
                          inlineBehaviours: kl([Jp("window-manager-inline-events", [Ur(Cr(), ((e, t) => {
                              ...
                              modes: ["top", "bottom"],
                              lazyViewport: e => jw(t, e.element).map((e => ({
                                  bounds: Gw(e),
                                  optScrollEnv: A.some({
                                      currentScrollTop: e.element.dom.scrollTop,
                                      scrollElmTop: Xt(e.element).top
                  ...
                  return c.set(g), Ph.showWithinBounds(g, ai(m.dialog), {
                      ...
                      const o = jw(t, e.element).map((e => Gw(e))).getOr(en()),
  ...
  tn.add("silver", (e => {
      ...
      return {
          renderUI: async () => {
              const o = await s();
              return jw(e, n.getMothership().element).each((e => {
                  t = () => Gw(e)
              })), o
          },
          ...
          getNotificationManagerImpl: () => ((e, t, o) => {
              ...
              return {
                  open: (t, r) => {
                      ...
                      o.add(l), h(t.timeout) && t.timeout > 0 && Uh.setEditorTimeout(e, (() => {
                          a()
                      }), t.timeout);
                      const c = {
                          close: a,
