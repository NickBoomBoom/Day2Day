...
!function () {
    ...
    var Gt = 16777215
        , Wt = 24
        , qt = new Map([[2, 22], [21, 22], [19, 20], [23, 24]]);
    function Jt(t, e) {
        function n(e) {
    ...
    var Ht, Qt = (Ht = ht(),
        ((t, e, n, r) => {
            ...
            value: Ht,
            enumerable: !0
        })), Ht)), Kt = new Set(["Atrule", "Selector", "Declaration"]), Yt = {};
    st(Yt, {
        safe: () => re,
        spec: () => ne
    });
    var Xt = (t, e) => {
        ...
        , Zt = [[1, 1], [1, 2], [1, 7], [1, 8], [1, "-"], [1, 10], [1, 11], [1, 12], [1, 15], [1, 21], [3, 1], [3, 2], [3, 7], [3, 8], [3, "-"], [3, 10], [3, 11], [3, 12], [3, 15], [4, 1], [4, 2], [4, 7], [4, 8], [4, "-"], [4, 10], [4, 11], [4, 12], [4, 15], [12, 1], [12, 2], [12, 7], [12, 8], [12, "-"], [12, 10], [12, 11], [12, 12], [12, 15], ["#", 1], ["#", 2], ["#", 7], ["#", 8], ["#", "-"], ["#", 10], ["#", 11], ["#", 12], ["#", 15], ["-", 1], ["-", 2], ["-", 7], ["-", 8], ["-", "-"], ["-", 10], ["-", 11], ["-", 12], ["-", 15], [10, 1], [10, 2], [10, 7], [10, 8], [10, 10], [10, 11], [10, 12], [10, "%"], [10, 15], ["@", 1], ["@", 2], ["@", 7], ["@", 8], ["@", "-"], ["@", 15], [".", 10], [".", 11], [".", 12], ["+", 10], ["+", 11], ["+", 12], ["/", "*"]]
        , te = Zt.concat([[1, 4], [12, 4], [4, 4], [3, 21], [3, 5], [3, 16], [11, 11], [11, 12], [11, 2], [11, "-"], [22, 1], [22, 2], [22, 11], [22, 12], [22, 4], [22, "-"]]);
    function ee(t) {
    ...
    function he(t, e) {
        let n = this.tokenStart + t
            , r = this.charCodeAt(n);
        for ((r === ae || r === le) && (e && this.error("Number sign is not allowed"),
            n++); n < this.tokenEnd; n++)
    ...
    function fe() {
        ...
        for (; 13 === n || 25 === n;)
            n = this.lookupType(++t);
        if (10 !== n) {
            if (!this.isDelim(ae, t) && !this.isDelim(le, t))
                return null;
    ...
    function me() {
        ...
        if (10 === this.tokenType)
        ...
        else if (1 === this.tokenType || this.isDelim(ae) && 1 === this.lookupType(1)) {
            let r = 0;
            switch (e = "1",
            this.isDelim(ae) && (r = 1,
                this.next()),
            ...
            s === this.tokenStart + i && this.error("Integer is expected", this.tokenStart + i),
                ...
                s + 1 === this.tokenEnd ? (this.next(),
                    n = fe.call(this)) : (pe.call(this, s - this.tokenStart + 1, le),
                        s + 2 === this.tokenEnd ? (this.next(),
                            this.skipSC(),
                            de.call(this, ue),
                            n = "-" + this.consume(10)) : (he.call(this, s - this.tokenStart + 2, ue),
                                this.next(),
                                n = this.substrToCursor(s + 1)))
        } else
            this.error();
        return null !== e && e.charCodeAt(0) === ae && (e = e.substr(1)),
    ...
    function Ae() {
        ...
        let t = this.tokenStart
            , e = !1;
        return this.isDelim(Se) ? (e = !0,
            this.next()) : this.isDelim(we) || this.eat(1),
            this.isDelim(we) ? this.charCodeAt(this.tokenStart + 1) !== ve ? (this.next(),
    ...
    function Le() {
        let t = this.tokenStart
            , e = this.charCodeAt(t);
        return e !== ve && e !== xe && e !== Ce && e !== be && e !== Se && e !== we && this.error("Attribute selector (=, ~=, ^=, $=, *=, |=) is expected"),
            this.next(),
            e !== ve && (this.isDelim(ve) || this.error("Equal sign is expected"),
                this.next()),
    ...
    function _e() {
        ...
        return this.eat(19),
            ...
            t = Ae.call(this),
            this.skipSC(),
            20 !== this.tokenType && (1 !== this.tokenType && (n = Le.call(this),
                this.skipSC(),
    ...
    var Ln = 42;
    function _n() {
        1 !== this.tokenType && !1 === this.isDelim(Ln) && this.error("Identifier or asterisk is expected"),
            this.next()
    }
    function Tn() {
        let t = this.tokenStart;
        return this.isDelim(124) ? (this.next(),
            _n.call(this)) : (_n.call(this),
        ...
        this.token(7, function (t) {
            ...
            for (let r = 0; r < t.length; r++) {
                ...
                0 !== i ? i <= 31 || 127 === i ? (e += "\\" + i.toString(16),
                    n = !0) : i === In || i === Pn || i === Nn || i === Mn || i === jn || i === Dn ? (e += "\\" + t.charAt(r),
                        n = !1) : (n && pt(i) && (e += " "),
                            e += t.charAt(r),
                            n = !1) : e += "\ufffd"
            }
    ...
    function qn({ source: t, line: e, column: n }, r) {
        ...
        let s = t.split(/\r\n?|\n|\f/)
            ...
            , c = 0;
        (n += (Wn.length - 1) * (s[e - 1].substr(0, n - 1).match(/\t/g) || []).length) > $n && (c = n - Gn + 3,
            n = Gn - 2);
        for (let t = o; t <= a; t++)
            t >= 0 && t < s.length && (s[t] = s[t].replace(/\t/g, Wn),
                s[t] = (c > 0 && s[t].length > c ? "\u2026" : "") + s[t].substr(c, $n - 2) + (s[t].length > c + $n - 1 ? "\u2026" : ""));
    ...
    var ir = function (t) {
        let e = ""
            ...
            , a = Object.assign(new class {
                ...
                lookupType(t) {
                    return (t += this.tokenIndex) < this.tokenCount ? this.offsetAndType[t] >> Wt : 0
                }
                lookupOffset(t) {
                    return (t += this.tokenIndex) < this.tokenCount ? this.offsetAndType[t - 1] & Gt : this.source.length
                }
                lookupValue(t, e) {
                    return (t += this.tokenIndex) < this.tokenCount && Nt(this.source, this.offsetAndType[t - 1] & Gt, this.offsetAndType[t] & Gt, e)
                }
                getTokenStart(t) {
                    return t === this.tokenIndex ? this.tokenStart : t > 0 ? t < this.tokenCount ? this.offsetAndType[t - 1] & Gt : this.offsetAndType[this.tokenCount] & Gt : this.firstCharOffset
                }
                substrToCursor(t) {
                ...
                skip(t) {
                    ...
                    e < this.tokenCount ? (this.tokenIndex = e,
                        ...
                        this.tokenType = e >> Wt,
                        this.tokenEnd = e & Gt) : (this.tokenIndex = this.tokenCount,
                            this.next())
                }
                next() {
                ...
                skipUntilBalanced(t, e) {
                    ...
                    t: for (; i < this.tokenCount && (n = this.balance[i],
                        !(n < t)); i++)
                        switch (r = i > 0 ? this.offsetAndType[i - 1] & Gt : this.firstCharOffset,
                ...
                error(t, n) {
                    ...
                    throw new Jn(t || "Unexpected input", e, r.offset, r.line, r.column)
                }
            });
        ...
        , mr = class {
            ...
            selectorString() {
                return "string" == typeof this.selector || this.selector instanceof String ? this.selector : this.selector instanceof Object && "Selector" === this.selector.type ? Un(this.selector) : ""
            }
            toObject() {
                return this.value
            }
    ...
    const gr = t => {
        ...
        , br = t => {
            const e = t.cssRules;
            return E(e, (t => (t => t.type === window.CSSRule.IMPORT_RULE)(t) ? br(t.styleSheet) : (t => t.type === window.CSSRule.STYLE_RULE)(t) ? [yr(t)] : []))
        }
        , Sr = (t, e) => ((t, e) => {
            const n = {};
            var r;
    ...
    const Cr = t => {
        ...
        , xr = (!1,
            (t, e, n) => wr((t => ((t, e) => L(t, (t => ((t, e) => ((t, e, n) => "" === e || t.length >= e.length && t.substr(0, 0 + e.length) === e)(t, e))(t.selector, e))))(t, n)), t, e, false));
    const Ar = (t, e, n) => wr((t => ((t, e) => L(t, (t => w(e, t.selector))))(t, n)), t, e, !1)
        , Lr = (t, e, n) => {
        ...
        , _r = (t, e, n, r) => {
            const i = (t => {
                ...
                , s = B("iframe");
            var o, a;
            return Lr(s, "src", t.source.value),
                Lr(s, "title", t.title),
                Lr(s, "name", t.name),
    ...
    tinymce.PluginManager.requireLangPack("pageembed", "ar,bg_BG,ca,cs,da,de,el,es,eu,fa,fi,fr_FR,he_IL,hi,hr,hu_HU,id,it,ja,kk,ko_KR,ms,nb_NO,nl,pl,pt_BR,pt_PT,ro,ru,sk,sl_SI,sv_SE,th_TH,tr,uk,vi,zh_CN,zh_TW"),
        ...
        )((t => r((t => [t.majorVersion, t.minorVersion].join(".").split(".").slice(0, 3).join("."))(t)))(t), r(n)))(tinymce, "6.4.0") ? (console.error("The pageembed plugin requires at least version 6.4.0 of TinyMCE"),
            {}) : (((t, e) => {
