  ...
  const a = t=>e=>e.options.get(t)
    ...
    , b = (t,e)=>{
      ...
      for (let t = 0; t < o.length; t++) {
          ...
          if (i === e.level)
              ...
              for (let t = i; t < e.level; t++)
                  n += `<${s.join(" ")}><li>`;
          if (n += '<a href="#' + e.id + '">' + e.title + "</a>",
          l !== e.level && l)
    ...
    , v = t=>{
      ...
      n.length && t.undoManager.transact((()=>{
          var e, o;
          t.dom.setHTML(n, b(t, (e = n[0],
          l.from(null === (o = e.firstElementChild) || void 0 === o ? void 0 : o.innerHTML))))
      }
      ))
  }
    , _ = t=>e=>{
          ...
          t.addCommand("mceInsertToc", (()=>{
              (t=>{
                  ...
                  ((t,e)=>!e.length || t.dom.getParents(e[0], ".mce-offscreen-selection").length > 0)(t, n) ? t.insertContent(((t,e)=>{
                      const n = b(t, e);
                      return '<div class="' + t.dom.encode(c(t)) + '" contenteditable="false" data-mce-toc="true">' + n + "</div>"
                  }
                  )(t, l.none())) : v(t)
              }
              )(t)
