  ...
  const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
      ...
      V = (e, t) => {
          const n = D(t.startContainer, t.startOffset),
              ...
              s = r.element.dom;
          return $(e, t.commonAncestorContainer, o, s, {
              text: (e, t) => {
              ...
              cef: t => {
                  return ((e, t) => {
                      ...
                      return 1 !== (o = n).nodeType && 9 !== o.nodeType && 11 !== o.nodeType || 0 === o.childElementCount ? [] : y(n.querySelectorAll(e), T);
                      var o
          ...
          return ((e, t) => {
              const n = (o = e, r = (e, n) => {
                  const o = B(n),
                      r = e.last,
                      s = r + o.length,
                      a = v(t, ((e, t) => e.start < s && e.finish > r ? [{
                          element: n,
      ...
      G = (e, t, n, o) => {
          const r = e.dom.create("span", {
              "data-mce-bogus": 1
          });
          r.className = "mce-match-marker";
          const s = e.getBody();
          return te(e, t, !1), o ? ((e, t, n, o) => {
      ...
      J = (e, t, n) => {
          ...
          let r = o.index;
          const s = e.dom;
          n ? r + 1 === o.count ? r = 0 : r++ : r - 1 == -1 ? r = o.count - 1 : r--, s.removeClass(H(e, o.index), "mce-match-marker-selected");
          const a = H(e, r);
      ...
      ne = (t, n) => {
          ...
          t.undoManager.add();
          const r = f.trim(t.selection.getContent({
                  format: "text"
              })),
              s = e => {
          ...
          o.set(t.windowManager.open(y(!1, p), {
              inline: "toolbar"
          }))
      },
      oe = (e, t) => () => {
