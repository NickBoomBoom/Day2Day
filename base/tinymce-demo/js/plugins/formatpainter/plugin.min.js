...
!function() {
      ...
      const o = D.browsers()
        ...
        , s = t.bind((e=>((e,t)=>((e,t)=>{
          ...
          return O(e, (e=>{
              ...
              current: e.name,
              version: T.nu(parseInt(t.version, 10), 0)
          })))
      }
      )))(o, e))).orThunk((()=>((e,t)=>_(e, t).map((e=>{
          const r = T.detect(e.versionRegexes, t);
          return {
              current: e.name,
              version: r
          }
  ...
  )((()=>te(navigator.userAgent, b.from(navigator.userAgentData), re)));
  const ne = ()=>oe()
    , se = Object.keys
  ...
  const ge = e=>t=>(e=>e.dom.nodeType)(t) === e
    ...
    , Ae = (e,t)=>{
      xe(e) ? e.dom.classList.remove(t) : ((e,t)=>{
          ((e,t,r)=>{
              const o = A(we(e, t), (e=>e !== r));
              o.length > 0 ? be(e, t, o.join(" ")) : Se(e, t)
          }
          )(e, "class", t)
      }
      )(e, t),
      (e=>{
          0 === (xe(e) ? e.dom.classList : ke(e)).length && Se(e, "class")
      }
      )(e)
  }
    , Oe = e=>{
  ...
  const Fe = e=>{
      ...
      xe(t) ? t.dom.classList.add(r) : ((e,t)=>{
          ((e,t,r)=>{
              const o = we(e, t).concat([r]);
              be(e, t, o.join(" "))
          }
          )(e, "class", t)
      }
    ...
    , Ee = (e,t)=>{
      (e=>{
          Ae(Ce(e.getBody()), "tox-cursor-format-painter")
      }
      )(e),
      t.set(Re.Retrival),
      Le(e, !1)
    ...
    , De = d(Element.prototype.attachShadow) && d(Node.prototype.getRootNode) ? e=>Ce(e.dom.getRootNode()) : e=>pe(e) ? e : Ce(e.dom.ownerDocument)
    , Ie = e=>Ce(e.dom.host)
    , je = e=>{
      ...
      return (e=>{
          const t = De(e);
          return ve(r = t) && u(r.dom.host) ? b.some(t) : b.none();
          var r
      }
      )(Ce(t)).fold((()=>r.body.contains(t)), (o = je,
      n = Ie,
      e=>o(n(e))));
      var o, n
  }
    ...
    , Ve = (e,t,r)=>((e,t,r,o,n)=>o(r) ? b.some(r) : d(n) && n(r) ? b.none() : t(r, o, n))(0, Me, e, t, r)
    , Ue = {
    ...
    , $e = e=>e.length > 1 && "%" === e.charAt(0)
    , qe = (e,t)=>ue(e, t).filter((e=>!c(e)))
    , ze = e=>Be(e, "OL,UL,DL")
    , Ke = e=>Be(e, "LI,DT,DD")
    , Ze = e=>e.replace(/([A-Z])/g, (e=>`-${e[0].toLowerCase()}`))
    , Ge = (e,t,r)=>{
      const o = e.formatter
        , n = ((e,t)=>x(e.formatter.get(t), (t=>((e,t)=>de(t, "inline") && !We(e, t))(e, t))))(e, r.formatName)
        , s = ((e,t,r)=>x(t.get(r), (t=>((e,t)=>de(t, "block") || We(e, t))(e, t))))(e, o, r.formatName)
        , i = (a = r.formatName,
    ...
    , He = e=>{
      const t = e.selection
        , r = t.getRng()
        , o = Ce(e.getBody())
        , n = (e=>A(e.selection.getSelectedBlocks().map(Ce), Ke))(e)
        , s = r.collapsed && n.length
        , i = n.length && !((e,t)=>{
          const r = e=>Ne(e, t);
          return (o = Ve(Ce(e.getStart()), ze, r),
          n = Ve(Ce(e.getEnd()), ze, r),
          s = (e,t)=>Ne(e, t),
    ...
    , Je = (e,t)=>{
      ...
      return "" !== o || je(e) ? o : Qe(r, t)
  }
    , Qe = (e,t)=>(e=>void 0 !== e.style && d(e.style.getPropertyValue))(e) ? e.style.getPropertyValue(t) : ""
    , Xe = ("formatpainter_ignored_formats",
  e=>e.options.get("formatpainter_ignored_formats"));
  const Ye = (e,t)=>{
      return "class" === t ? (e=>xe(e) ? (e=>{
      ...
      )(e) : ke(e))(e).filter((e=>!/^(mce-.*)/.test(e))).join(" ") : (r = e,
      o = t,
      b.from(ye(r, o))).getOr("");
      var r, o
  }
    ...
    , tt = (e,t)=>(e=>{
      ...
      const o = ((e,t)=>x(e.formatter.get(t), (e=>(e=>{
          const t = qe(e, "styles").exists((e=>x(me(e), $e)))
            , r = qe(e, "attributes").exists((e=>x(me(e), $e)));
          return t || r
      }
      )(e))))(e, r);
    ...
    , rt = (e,t)=>{
      const r = k(e.dom.getParents(t, v), Ce);
      return C(A(r, he), (t=>C(tt(e, t), (r=>((e,t,r)=>{
          return (o = e.get(t),
          ((e,t)=>0 < e.length ? b.some(e[0]) : b.none())(o)).bind((e=>((e,t)=>{
              const r = qe(e, "styles").map((e=>{
                  return r = t,
                  o = et(e),
                  ce(o, ((e,t)=>({
    ...
    , ot = e=>(e=>O(me(_e), (t=>e.queryCommandState(t))))(e).map((e=>({
      kind: Te.ListSchema,
      command: e
  })))
    , nt = (e,t)=>e.getParent(t, "TABLE") ? Pe.Table : Pe.Unspecified
    , st = (t,r,o)=>{
      t.addCommand("mceToggleFormatPainter", (()=>{
          ((t,r)=>{
              r.get() === Re.Application ? Ee(t, r) : ((t,r)=>{
                  const o = ne()
                    , n = e(!1);
                  Fe(t),
                  r.set(Re.Application),
                  Le(t, !0),
                  ...
                  const s = ()=>{
                    ...
                    , i = ()=>{
                      r.get() === Re.Application && s(),
                      m()
                  }
                    , a = e=>{
                      r.get() === Re.Application && ("touchcancel" === e.type && o.os.isAndroid() ? t.once("contextmenu", s) : n.get() ? s() : t.once("selectionchange", s)),
                      m()
                  }
                    , c = e=>{
                      27 === e.keyCode && (Ee(t, r),
  ...
  tinymce.PluginManager.add("formatpainter", (t=>{
      ...
      const o = e(Re.Retrival)
        , s = e({
          schemas: [],
          context: Pe.Unspecified
      });
      (e=>{
          (0,
      ...
      ((e,t)=>{
          e.ui.registry.addToggleMenuItem("formatpainter", {
              ...
              onSetup: r=>{
                  ...
                  ;
                  return r.setActive(t.get() === Re.Application),
