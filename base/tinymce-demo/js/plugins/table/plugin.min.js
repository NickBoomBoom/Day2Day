...
! function() {
  ...
  const ie = (e, t, o) => {
      ...
      de = (e, t) => ((e, o) => B(e.dom.childNodes, (e => {
  ...
  const Ie = e => e.length > 0,
      ...
      Je = e => {
          const t = {},
              o = [];
          var l;
          const n = (l = e, L(l, 0)).map((e => e.element)).bind($e).bind(Ge).getOr({});
          let r = 0,
              a = 0,
              s = 0;
          const {
  ...
  const jt = (e, t, o, l) => {
      ...
      $t = {
          ...
          attrs: d({
              ...
              copyTo: (e, t) => {
                  ...
                  })(t, E(e.dom.attributes, ((e, t) => (e[t.name] = t.value, e)), {}))
              }
          }),
          insert: d({
              before: kt,
      ...
      Wt = e => me(e, "table"),
      zt = (e, t, o) => ue(e, t).bind((t => ue(e, o).bind((e => {
          return (o = Wt, l = [t, e], ((e, t, o) => o.length > 0 ? ((e, t, o, l) => l(e, t, o[0], o.slice(1)))(e, t, o, jt) : y.none())($t, ((e, t) => o(t)), l)).map((o => ({
              first: t,
              last: e,
              table: o
          })));
      ...
      Xt = e => (t, o) => {
          const l = G(t),
              n = "col" === l || "colgroup" === l ? $e(r = t).bind((e => ((e, t) => ((e, t) => {
                  const o = Ce(e, t);
                  return o.length > 0 ? y.some(o) : y.none()
              })(e, t))(e, Qt.firstSelectedSelector))).fold(d(r), (e => e[0])) : t;
          var r;
          return pe(n, e, o)
      },
      Yt = Xt("th,td,caption"),
      ...
      so = e => {
          return t = ao(e.red) + ao(e.green) + ao(e.blue), {
              value: ro(t)
          };
          var t
      },
      ...
      go = (e, t, o) => l => {
          const n = (e => {
              ...
              a = () => {
                  ...
                  r ? (l.setActive(!N(a, s)), n.set(e.formatter.formatChanged(t, (e => l.setActive(!e)), !0))) : (l.setActive(q(a, s)), n.set(e.formatter.formatChanged(t, l.setActive, !1, {
                      value: o
                  })))
              };
      ...
      vo = (e, t, o) => {
          const l = M(t, (e => {
              return {
                  text: e.title,
                  value: "#" + (o = e.value, (t = o, (e => lo.test(e) || no.test(e))(t) ? y.some({
                      value: ro(t)
                  }) : y.none()).orThunk((() => po(o).map(so))).getOrThunk((() => {
      ...
      Po = (e, t, o) => {
          const l = (e => {
              ...
              return (l = t, ((e, t, o = h) => o(t) ? y.none() : D(e, G(t)) ? y.some(t) : me(t, e.join(","), (e => $(e, "table") || o(e))))(["td", "th"], l, n)).bind((t => Mo(e, t))).filter(o);
              var l, n
          })));
      ...
      Lo = e => {
          return _e(e, "rgb") ? po(t = e).map(so).map((e => "#" + e.value)).getOr(t) : e;
          var t
      },
      Ho = e => {
          const t = V.fromDom(e);
                  ...
                  T(n) > 0 && t.length >= 1 && $e(t[0]).each((o => {
                      ...
                      (a || A(n, "scope")) && ((e, t, o, l) => {
                          ...
                          P(t, (t => {
                              ...
                              })(s, t.column.map((t => _o(e, t))).getOr(s), o, a), gt(e) && ((e, t, o) => {
      ...
      Ko = e => {
          ...
          const o = ((e, t) => {
                  const o = $e(t[0]).map((o => M(Uo(o, t), (t => ((e, t, o, l) => {
                      const n = e.dom,
          ...
          l.close(), e.undoManager.transact((() => {
              ((e, t, o, l) => {
                  ...
                  if (T(n) > 0) {
                      ...
                      })(e, l), $e(V.fromDom(t[0])).each((t => lt(e, t.dom, {
                          structure: o,
                          style: r
                      })))
                  }
          ...
          l.close(), "" === r.class && delete r.class, e.undoManager.transact((() => {
              if (!t) {
                  ...
                  e.execCommand("mceInsertTable", !1, {
                      rows: l,
                      columns: o
                  }), t = Zt(ye(e), he(e)).bind((t => $e(t, he(e)))).map((e => e.dom)).getOrDie()
              }
              if (T(s) > 0) {
                  const o = {
                      border: A(s, "border"),
                  ...
                  ((e, t, o, l) => {
                      const n = e.dom,
                          ...
                          c = St(e),
                          i = ft(e);
                      if (a(o.class) || (r.class = o.class), s.height = fe(o.height), c ? s.width = fe(o.width) : n.getAttrib(t, "width") && (r.width = (e => e ? e.replace(/px$/, "") : "")(o.width)), c ? (s["border-width"] = fe(o.border), s["border-spacing"] = fe(o.cellspacing)) : (r.border = o.border, r.cellpadding = o.cellpadding, r.cellspacing = o.cellspacing), c && t.children) {
                          const e = {};
                          if (l.border && (e["border-width"] = fe(o.border)), l.cellpadding && (e.padding = fe(o.cellpadding)), i && l.bordercolor && (e["border-color"] = o.bordercolor), !(e => {
                                  for (const t in e)
      ...
      al = (e, t, o) => {
          return t.length <= 1 ? y.none() : (l = e, n = o.firstSelectedSelector, r = o.lastSelectedSelector, zt(l, n, r).bind((e => {
              const t = e => z(l, e),
                  o = "thead,tfoot,tbody,table",
                  n = me(e.first, o, t),
                  r = me(e.last, o, t);
              return n.bind((t => r.bind((o => z(t, o) ? ((e, t, o) => {
                  const l = Pt(e);
                  return Mt(l, t, o)
      ...
      sl = e => {
          ...
          const n = ee("caption"),
              r = e => l.forall((t => !t[e])),
              a = () => Yt(ye(e), he(e)).bind((t => {
                  return o = Oe($e(t), Yt((e => V.fromDom(e.selection.getEnd()))(e), he(e)).bind($e), ((o, l) => z(o, l) ? n(t) ? y.some((e => ({
                      element: e,
                      mergable: y.none(),
                      unmergable: y.none(),
                      selection: [e]
                      ...
                      unmergable: rl(e),
                      selection: nl(e)
                  }))(eo(e), o, t)) : y.none())), o.bind(u);
                  var o
              })),
              s = e => $e(e.element).map((t => {
                  const o = Qe(t),
                      l = ko(o, e).getOr([]),
