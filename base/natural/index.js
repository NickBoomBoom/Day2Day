...
我曾发布 tailwind-extensions 和 unocss-preset-element-plus 两个包，方便将 element-plus 和 tailwindcss、unocss 结合起来使用。我还给 element-plus 提过两个 PR #12549 和 #14062，提高了 FormRules 类型质量。
...
` 
 ...
 import {extract, tag} from 'nodejs-jieba'
// 使用分词工具分词 
console.log(111, extract(text, 10))
console.log(222, tag(text))
// 打印提取的标签
/* wink-nlp-utils */
import nlp from 'wink-nlp-utils'
console.log(1, nlp.string.tokenize(text))

// import natural from 'natural'

// console.log(new natural.WordTokenizer().tokenize(text))